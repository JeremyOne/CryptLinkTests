...
namespace CryptLinkTests {
    ...
    public class TestX509CertBuilder{
        ...
        public void X509CertBuilding() {
			...
			var intermediate1 = new X509Certificate2Builder { SubjectName = "CN=Intermediate 1", Issuer = ca1, KeyStrength = 1024 }.Build();
			...
			var intermediate2 = new X509Certificate2Builder { SubjectName = "CN=Intermediate 2", Issuer = intermediate1, KeyStrength = 1024 }.Build();
			...
			var cert1 = new X509Certificate2Builder { SubjectName = "CN=Test 1", Issuer = intermediate1, Intermediate = false, KeyStrength = 1024 }.Build();
			...
			var cert2 = new X509Certificate2Builder { SubjectName = "CN=Test 2", Issuer = intermediate2, KeyStrength = 1024 }.Build();
			...
			var cert3 = new X509Certificate2Builder { SubjectName = "CN=Test 3", Issuer = cert2, KeyStrength = 1024 }.Build();
			...
			var ca2 = new X509Certificate2Builder { SubjectName = "CN=Test CA2", KeyStrength = 1024 }.Build();
